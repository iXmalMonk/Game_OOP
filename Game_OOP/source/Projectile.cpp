...
Projectile::Projectile(Vector2f _position, Direction _direction, GameObjectType _gameObjectTypeWhoShooted, GameObject* _gameObjectWhoShooted) : destroyed(false)
{
	w = PROJECTILE_W;
	h = PROJECTILE_H;
